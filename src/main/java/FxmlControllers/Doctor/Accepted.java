...
//        timeOfNotification.setText("✮ 4.5"); //for testing
    ...
    public void viewDetail(String username){//for testing
        ...
        //for testing
        overviewName.setText(":     "+ GetFrom_DB.getFullNameByUsername(patientUserName));
        overviewAge.setText(":     "+GetFrom_DB.getEmailByUsername(patientUserName));
        overviewContact.setText(":     "+GetFrom_DB.getMobileByUsername(patientUserName));
        overviewGender.setText(":     "+GetFrom_DB.getGenderByUsername(patientUserName));
    }
    ...
    public void loadData() {
        String sql = "SELECT doctor_id, patient_id, request_id, is_approved FROM appointment_request";
